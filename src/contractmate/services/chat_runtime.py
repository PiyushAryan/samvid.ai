...
class DatabaseHybridRetriever:
    """Scoped lexical plus pgvector retrieval, with OpenRouter reranking."""

    repository: KnowledgeRepository
    embeddings: OpenRouterEmbeddingsClient
    reranker: OpenRouterRerankClient
...
def chat_retriever_from_settings(*, settings: Settings, repository: KnowledgeRepository) -> DatabaseHybridRetriever:
    if not settings.openrouter_api_key:
        raise RuntimeError("OPENROUTER_API_KEY is required for contract chat.")
